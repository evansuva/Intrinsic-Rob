...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='ACGAN', choices=['GAN', 'CGAN', 'ACGAN'], 
    ...
    parser.add_argument('--n_samples', type=int, default=1000, help='number of natural samples')
    parser.add_argument('--n_neighbors', type=int, default=2000, help='number of neighboring points')
